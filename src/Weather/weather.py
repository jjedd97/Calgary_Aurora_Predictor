...
if RowIndex == 0:
    log.error('Sorry, but it appears that there was an error connecting to the weather server.')
...
if RowIndex == 1:
    log.error('Sorry, but it appears that there was an error retrieving the weather data.')
    log.error('Error: ', FirstRow)
